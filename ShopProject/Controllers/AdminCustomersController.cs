...
namespace ShopProject.Controllers
{
    ...
    public class AdminCustomersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,Password,Address,Phone,Birthday,Admin")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email,Password,Address,Phone,Birthday,Admin")] Customer customer)
        {
            if (id != customer.Id)
            {
                return NotFound();
